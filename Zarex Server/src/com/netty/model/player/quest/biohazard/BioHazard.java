package com.netty.model.player.quest.biohazard;
...
public class BioHazard extends Quest {
	 ...
	 * 			The id to set.
	 */
	public BioHazard(String name, Player player, QuestStage questStage, QuestType questType) {
