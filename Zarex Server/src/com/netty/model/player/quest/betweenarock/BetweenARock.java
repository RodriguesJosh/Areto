package com.netty.model.player.quest.betweenarock;
 ...
 * @since Sep 22, 2011 3:57:41 PM
 */
public class BetweenARock extends Quest {
	 ...
	 * 			The id to set.
	 */
	public BetweenARock(String name, Player player, QuestStage questStage, QuestType questType) {
