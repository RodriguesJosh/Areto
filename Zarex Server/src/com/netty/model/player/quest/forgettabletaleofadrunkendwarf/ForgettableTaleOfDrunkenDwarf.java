package com.netty.model.player.quest.forgettabletaleofadrunkendwarf;
 ...
 * @since Sep 22, 2011 6:26:23 PM
 */
public class ForgettableTaleOfDrunkenDwarf extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ForgettableTaleOfDrunkenDwarf(String name, Player player, QuestStage questStage, QuestType questType) {
