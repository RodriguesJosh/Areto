package com.netty.model.player.quest.witchshouse;
...
public class WitchsHouse extends Quest {
	 ...
	 * 			The id to set.
	 */
	public WitchsHouse(String name, Player player, QuestStage questStage, QuestType questType) {
