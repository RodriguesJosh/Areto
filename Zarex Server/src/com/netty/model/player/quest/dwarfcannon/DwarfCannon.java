package com.netty.model.player.quest.dwarfcannon;
...
public class DwarfCannon extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DwarfCannon(String name, Player player, QuestStage questStage, QuestType questType) {
