package com.netty.model.player.quest.atailoftwocats;
 ...
 * @since Sep 22, 2011 3:57:19 PM
 */
public class ATailOfTwoCats extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ATailOfTwoCats(String name, Player player, QuestStage questStage, QuestType questType) {
