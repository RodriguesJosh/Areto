package com.netty.model.player.quest.familycrest;
...
public class FamilyCrest extends Quest {
	 ...
	 * 			The id to set.
	 */
	public FamilyCrest(String name, Player player, QuestStage questStage, QuestType questType) {
