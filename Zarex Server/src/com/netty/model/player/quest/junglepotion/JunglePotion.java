package com.netty.model.player.quest.junglepotion;
...
public class JunglePotion extends Quest {
	 ...
	 * 			The id to set.
	 */
	public JunglePotion(String name, Player player, QuestStage questStage, QuestType questType) {
