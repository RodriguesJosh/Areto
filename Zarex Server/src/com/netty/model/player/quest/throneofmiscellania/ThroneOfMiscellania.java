package com.netty.model.player.quest.throneofmiscellania;
 ...
 * @since Sep 22, 2011 4:00:34 PM
 */
public class ThroneOfMiscellania extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ThroneOfMiscellania(String name, Player player, QuestStage questStage, QuestType questType) {
