package com.netty.model.player.quest.lovestory;
 ...
 * @since Sep 22, 2011 5:15:28 PM
 */
public class LoveStory extends Quest {
	 ...
	 * 			The id to set.
	 */
	public LoveStory(String name, Player player, QuestStage questStage, QuestType questType) {
