package com.netty.model.player.quest.toweroflife;
 ...
 * @since Sep 22, 2011 4:00:11 PM
 */
public class TowerOfLife extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TowerOfLife(String name, Player player, QuestStage questStage, QuestType questType) {
