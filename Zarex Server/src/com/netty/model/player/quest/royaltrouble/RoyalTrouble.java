package com.netty.model.player.quest.royaltrouble;
 ...
 * @since Sep 22, 2011 4:49:44 PM
 */
public class RoyalTrouble extends Quest {
	 ...
	 * 			The id to set.
	 */
	public RoyalTrouble(String name, Player player, QuestStage questStage, QuestType questType) {
