package com.netty.model.player.quest.merlinscrystal;
...
public class MerlinsCrystal extends Quest {
	 ...
	 * 			The id to set.
	 */
	public MerlinsCrystal(String name, Player player, QuestStage questStage, QuestType questType) {
