package com.netty.model.player.quest.ragandboneman;
 ...
 * @since Sep 22, 2011 4:51:25 PM
 */
public class RagAndBoneMan extends Quest {
	 ...
	 * 			The id to set.
	 */
	public RagAndBoneMan(String name, Player player, QuestStage questStage, QuestType questType) {
