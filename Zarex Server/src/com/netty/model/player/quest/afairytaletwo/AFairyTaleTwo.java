package com.netty.model.player.quest.afairytaletwo;
 ...
 * @since Sep 22, 2011 3:56:08 PM
 */
public class AFairyTaleTwo extends Quest {
	 ...
	 * 			The id to set.
	 */
	public AFairyTaleTwo(String name, Player player, QuestStage questStage, QuestType questType) {
