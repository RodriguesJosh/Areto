package com.netty.model.player.quest.trollromance;
 ...
 * @since Sep 22, 2011 1:47:56 PM
 */
public class TrollRomance extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TrollRomance(String name, Player player, QuestStage questStage, QuestType questType) {
