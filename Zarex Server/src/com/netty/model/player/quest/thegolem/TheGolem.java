package com.netty.model.player.quest.thegolem;
 ...
 * @since Sep 22, 2011 4:24:03 PM
 */
public class TheGolem extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheGolem(String name, Player player, QuestStage questStage, QuestType questType) {
