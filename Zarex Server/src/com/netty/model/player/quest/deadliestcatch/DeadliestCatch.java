package com.netty.model.player.quest.deadliestcatch;
 ...
 * @since Sep 22, 2011 6:33:34 PM
 */
public class DeadliestCatch extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DeadliestCatch(String name, Player player, QuestStage questStage, QuestType questType) {
