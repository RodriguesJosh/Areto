package com.netty.model.player.quest.animalmagnetism;
 ...
 * @since Sep 22, 2011 3:56:54 PM
 */
public class AnimalMagnetism extends Quest {
	 ...
	 * 			The id to set.
	 */
	public AnimalMagnetism(String name, Player player, QuestStage questStage, QuestType questType) {
