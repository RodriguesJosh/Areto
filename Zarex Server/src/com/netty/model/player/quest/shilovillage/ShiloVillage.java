package com.netty.model.player.quest.shilovillage;
...
public class ShiloVillage extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ShiloVillage(String name, Player player, QuestStage questStage, QuestType questType) {
