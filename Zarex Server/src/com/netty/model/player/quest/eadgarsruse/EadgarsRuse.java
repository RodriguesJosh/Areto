package com.netty.model.player.quest.eadgarsruse;
 ...
 * @since Sep 22, 2011 6:27:55 PM
 */
public class EadgarsRuse extends Quest {
	 ...
	 * 			The id to set.
	 */
	public EadgarsRuse(String name, Player player, QuestStage questStage, QuestType questType) {
