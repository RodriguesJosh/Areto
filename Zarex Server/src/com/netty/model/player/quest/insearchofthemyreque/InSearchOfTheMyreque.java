package com.netty.model.player.quest.insearchofthemyreque;
 ...
 * @since Sep 22, 2011 5:32:42 PM
 */
public class InSearchOfTheMyreque extends Quest {
	 ...
	 * 			The id to set.
	 */
	public InSearchOfTheMyreque(String name, Player player, QuestStage questStage, QuestType questType) {
