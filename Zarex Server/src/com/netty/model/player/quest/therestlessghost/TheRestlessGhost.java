package com.netty.model.player.quest.therestlessghost;
...
public class TheRestlessGhost extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheRestlessGhost(String name, Player player, QuestStage questStage, QuestType questType) {
