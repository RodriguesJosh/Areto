package com.netty.model.player.quest.plaguecity;
...
public class PlagueCity extends Quest {
	 ...
	 * 			The id to set.
	 */
	public PlagueCity(String name, Player player, QuestStage questStage, QuestType questType) {
