package com.netty.model.player.quest.runemysteries;
...
public class RuneMysteries extends Quest {
	 ...
	 * 			The id to set.
	 */
	public RuneMysteries(String name, Player player, QuestStage questStage, QuestType questType) {
