package com.netty.model.player.quest.tearsofguthix;
 ...
 * @since Sep 22, 2011 4:30:15 PM
 */
public class TearsOfGuthix extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TearsOfGuthix(String name, Player player, QuestStage questStage, QuestType questType) {
