package com.netty.model.player.quest.holygrail;
...
public class HolyGrail extends Quest {
	 ...
	 * 			The id to set.
	 */
	public HolyGrail(String name, Player player, QuestStage questStage, QuestType questType) {
