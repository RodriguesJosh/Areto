package com.netty.model.player.quest.ghostsahoy;
 ...
 * @since Sep 22, 2011 6:25:35 PM
 */
public class GhostsAhoy extends Quest {
	 ...
	 * 			The id to set.
	 */
	public GhostsAhoy(String name, Player player, QuestStage questStage, QuestType questType) {
