package com.netty.model.player.quest.enakhraslament;
 ...
 * @since Sep 22, 2011 6:27:14 PM
 */
public class EnakhrasLament extends Quest {
	 ...
	 * 			The id to set.
	 */
	public EnakhrasLament(String name, Player player, QuestStage questStage, QuestType questType) {
