package com.netty.model.player.quest.piratestreasure;
 ...
 * @since Sep 22, 2011 4:59:44 PM
 */
public class PirateTreasure extends Quest {
	 ...
	 * 			The id to set.
	 */
	public PirateTreasure(String name, Player player, QuestStage questStage, QuestType questType) {
