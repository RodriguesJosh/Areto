package com.netty.model.player.quest.huntforredraktuber;
 ...
 * @since Sep 22, 2011 5:44:42 PM
 */
public class HuntForRedRaktuber extends Quest {
	 ...
	 * 			The id to set.
	 */
	public HuntForRedRaktuber(String name, Player player, QuestStage questStage, QuestType questType) {
