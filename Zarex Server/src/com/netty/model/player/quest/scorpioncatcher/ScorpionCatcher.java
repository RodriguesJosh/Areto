package com.netty.model.player.quest.scorpioncatcher;
...
public class ScorpionCatcher extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ScorpionCatcher(String name, Player player, QuestStage questStage, QuestType questType) {
