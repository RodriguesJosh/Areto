package com.netty.model.player.quest.watchtower;
...
public class Watchtower extends Quest {
	 ...
	 * 			The id to set.
	 */
	public Watchtower(String name, Player player, QuestStage questStage, QuestType questType) {
