package com.netty.model.player.quest.spiritsoftheelid;
 ...
 * @since Sep 22, 2011 4:31:48 PM
 */
public class SpiritsOfTheElid extends Quest {
	 ...
	 * 			The id to set.
	 */
	public SpiritsOfTheElid(String name, Player player, QuestStage questStage, QuestType questType) {
