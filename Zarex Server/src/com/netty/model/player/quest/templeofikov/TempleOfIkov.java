package com.netty.model.player.quest.templeofikov;
...
public class TempleOfIkov extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TempleOfIkov(String name, Player player, QuestStage questStage, QuestType questType) {
