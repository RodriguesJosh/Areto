package com.netty.model.player.quest.fightarena;
...
public class FightArena extends Quest {
	 ...
	 * 			The id to set.
	 */
	public FightArena(String name, Player player, QuestStage questStage, QuestType questType) {
