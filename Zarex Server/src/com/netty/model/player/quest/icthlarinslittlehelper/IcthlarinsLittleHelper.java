package com.netty.model.player.quest.icthlarinslittlehelper;
 ...
 * @since Sep 22, 2011 5:44:31 PM
 */
public class IcthlarinsLittleHelper extends Quest {
	 ...
	 * 			The id to set.
	 */
	public IcthlarinsLittleHelper(String name, Player player, QuestStage questStage, QuestType questType) {
