package com.netty.model.player.quest.elementalworkshopfour;
 ...
 * @since Sep 22, 2011 6:27:40 PM
 */
public class ElementalWorkshopFour extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ElementalWorkshopFour(String name, Player player, QuestStage questStage, QuestType questType) {
