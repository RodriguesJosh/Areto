package com.netty.model.player.quest.thevoidstaresback;
 ...
 * @since Sep 22, 2011 4:03:50 PM
 */
public class TheVoidStaresBack extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheVoidStaresBack(String name, Player player, QuestStage questStage, QuestType questType) {
