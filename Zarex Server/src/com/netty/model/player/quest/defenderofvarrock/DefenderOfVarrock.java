package com.netty.model.player.quest.defenderofvarrock;
 ...
 * @since Sep 22, 2011 6:32:48 PM
 */
public class DefenderOfVarrock extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DefenderOfVarrock(String name, Player player, QuestStage questStage, QuestType questType) {
