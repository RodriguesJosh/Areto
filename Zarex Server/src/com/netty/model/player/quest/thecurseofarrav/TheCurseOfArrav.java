package com.netty.model.player.quest.thecurseofarrav;
 ...
 * @since Sep 22, 2011 4:28:17 PM
 */
public class TheCurseOfArrav extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheCurseOfArrav(String name, Player player, QuestStage questStage, QuestType questType) {
