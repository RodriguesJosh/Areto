package com.netty.model.player.quest.donoevil;
 ...
 * @since Sep 22, 2011 6:28:34 PM
 */
public class DoNoEvil extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DoNoEvil(String name, Player player, QuestStage questStage, QuestType questType) {
