package com.netty.model.player.quest.prisonerofglouphrie;
 ...
 * @since Sep 22, 2011 4:51:46 PM
 */
public class PrisonerOfGlouphrie extends Quest {
	 ...
	 * 			The id to set.
	 */
	public PrisonerOfGlouphrie(String name, Player player, QuestStage questStage, QuestType questType) {
