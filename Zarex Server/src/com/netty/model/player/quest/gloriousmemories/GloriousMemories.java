package com.netty.model.player.quest.gloriousmemories;
 ...
 * @since Sep 22, 2011 6:25:23 PM
 */
public class GloriousMemories extends Quest {
	 ...
	 * 			The id to set.
	 */
	public GloriousMemories(String name, Player player, QuestStage questStage, QuestType questType) {
