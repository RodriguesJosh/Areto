package com.netty.model.player.quest.anothersliceofham;
 ...
 * @since Sep 22, 2011 3:56:43 PM
 */
public class AnotherSliceOfHAM extends Quest {
	 ...
	 * 			The id to set.
	 */
	public AnotherSliceOfHAM(String name, Player player, QuestStage questStage, QuestType questType) {
