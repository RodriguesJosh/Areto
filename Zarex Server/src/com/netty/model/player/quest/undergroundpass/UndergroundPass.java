package com.netty.model.player.quest.undergroundpass;
...
public class UndergroundPass extends Quest {
	 ...
	 * 			The id to set.
	 */
	public UndergroundPass(String name, Player player, QuestStage questStage, QuestType questType) {
