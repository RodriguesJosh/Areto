package com.netty.model.player.quest.clocktower;
...
public class ClockTower extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ClockTower(String name, Player player, QuestStage questStage, QuestType questType) {
