package com.netty.model.player.quest.whileguthixsleeps;
 ...
 * @since Sep 22, 2011 1:43:18 PM
 */
public class WhileGuthixSleeps extends Quest {
	 ...
	 * 			The id to set.
	 */
	public WhileGuthixSleeps(String name, Player player, QuestStage questStage, QuestType questType) {
