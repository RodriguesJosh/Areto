package com.netty.model.player.quest.elementalworkshopthree;
 ...
 * @since Sep 22, 2011 6:27:26 PM
 */
public class ElementalWorkshopThree extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ElementalWorkshopThree(String name, Player player, QuestStage questStage, QuestType questType) {
