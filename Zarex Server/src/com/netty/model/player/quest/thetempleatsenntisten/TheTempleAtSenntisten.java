package com.netty.model.player.quest.thetempleatsenntisten;
 ...
 * @since Sep 22, 2011 4:04:31 PM
 */
public class TheTempleAtSenntisten extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheTempleAtSenntisten(String name, Player player, QuestStage questStage, QuestType questType) {
