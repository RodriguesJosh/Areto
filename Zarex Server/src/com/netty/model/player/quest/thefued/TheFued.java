package com.netty.model.player.quest.thefued;
 ...
 * @since Sep 22, 2011 4:24:57 PM
 */
public class TheFued extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheFued(String name, Player player, QuestStage questStage, QuestType questType) {
