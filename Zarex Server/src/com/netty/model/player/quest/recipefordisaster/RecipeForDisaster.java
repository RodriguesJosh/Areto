package com.netty.model.player.quest.recipefordisaster;
...
public class RecipeForDisaster extends Quest {
	 ...
	 * 			The id to set.
	 */
	public RecipeForDisaster(String name, Player player, QuestStage questStage, QuestType questType) {
