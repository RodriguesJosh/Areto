package com.netty.model.player.quest.catapultconstruction;
 ...
 * @since Sep 22, 2011 6:34:51 PM
 */
public class CatapultConstruction extends Quest {
	 ...
	 * 			The id to set.
	 */
	public CatapultConstruction(String name, Player player, QuestStage questStage, QuestType questType) {
