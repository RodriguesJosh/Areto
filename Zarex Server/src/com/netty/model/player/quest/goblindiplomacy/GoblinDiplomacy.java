package com.netty.model.player.quest.goblindiplomacy;
...
public class GoblinDiplomacy extends Quest {
	 ...
	 * 			The id to set.
	 */
	public GoblinDiplomacy(String name, Player player, QuestStage questStage, QuestType questType) {
