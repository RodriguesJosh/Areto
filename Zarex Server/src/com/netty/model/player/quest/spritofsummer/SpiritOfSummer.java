package com.netty.model.player.quest.spritofsummer;
 ...
 * @since Sep 22, 2011 4:30:52 PM
 */
public class SpiritOfSummer extends Quest {
	 ...
	 * 			The id to set.
	 */
	public SpiritOfSummer(String name, Player player, QuestStage questStage, QuestType questType) {
