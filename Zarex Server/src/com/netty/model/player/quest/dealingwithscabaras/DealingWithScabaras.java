package com.netty.model.player.quest.dealingwithscabaras;
 ...
 * @since Sep 22, 2011 6:33:23 PM
 */
public class DealingWithScabaras extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DealingWithScabaras(String name, Player player, QuestStage questStage, QuestType questType) {
