package com.netty.model.player.quest.doricsquest;
...
public class DoricsQuest extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DoricsQuest(String name, Player player, QuestStage questStage, QuestType questType) {
