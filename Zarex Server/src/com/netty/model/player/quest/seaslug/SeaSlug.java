package com.netty.model.player.quest.seaslug;
...
public class SeaSlug extends Quest {
	 ...
	 * 			The id to set.
	 */
	public SeaSlug(String name, Player player, QuestStage questStage, QuestType questType) {
