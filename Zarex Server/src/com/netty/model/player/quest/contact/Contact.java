package com.netty.model.player.quest.contact;
 ...
 * @since Sep 22, 2011 6:34:16 PM
 */
public class Contact extends Quest {
	 ...
	 * 			The id to set.
	 */
	public Contact(String name, Player player, QuestStage questStage, QuestType questType) {
