package com.netty.model.player.quest.afairytaleone;
 ...
 * @since Sep 22, 2011 3:55:48 PM
 */
public class AFairyTaleOne extends Quest {
	 ...
	 * 			The id to set.
	 */
	public AFairyTaleOne(String name, Player player, QuestStage questStage, QuestType questType) {
