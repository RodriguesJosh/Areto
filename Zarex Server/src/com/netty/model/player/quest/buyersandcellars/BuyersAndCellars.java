package com.netty.model.player.quest.buyersandcellars;
 ...
 * @since Sep 22, 2011 6:35:07 PM
 */
public class BuyersAndCellars extends Quest {
	 ...
	 * 			The id to set.
	 */
	public BuyersAndCellars(String name, Player player, QuestStage questStage, QuestType questType) {
