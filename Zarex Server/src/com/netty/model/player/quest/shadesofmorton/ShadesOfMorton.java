package com.netty.model.player.quest.shadesofmorton;
 ...
 * @since Sep 22, 2011 4:40:45 PM
 */
public class ShadesOfMorton extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ShadesOfMorton(String name, Player player, QuestStage questStage, QuestType questType) {
