package com.netty.model.player.quest.deathtothedorgeshuun;
 ...
 * @since Sep 22, 2011 6:33:03 PM
 */
public class DeathToTheDorgeshuun extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DeathToTheDorgeshuun(String name, Player player, QuestStage questStage, QuestType questType) {
