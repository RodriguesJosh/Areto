package com.netty.model.player.quest.rockingout;
 ...
 * @since Sep 22, 2011 4:49:58 PM
 */
public class RockingOut extends Quest {
	 ...
	 * 			The id to set.
	 */
	public RockingOut(String name, Player player, QuestStage questStage, QuestType questType) {
