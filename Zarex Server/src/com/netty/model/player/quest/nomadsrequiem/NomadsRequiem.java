package com.netty.model.player.quest.nomadsrequiem;
 ...
 * @since Sep 22, 2011 5:01:48 PM
 */
public class NomadsRequiem extends Quest {
	 ...
	 * 			The id to set.
	 */
	public NomadsRequiem(String name, Player player, QuestStage questStage, QuestType questType) {
