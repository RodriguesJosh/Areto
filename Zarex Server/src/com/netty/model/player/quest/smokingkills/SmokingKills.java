package com.netty.model.player.quest.smokingkills;
 ...
 * @since Sep 22, 2011 4:32:04 PM
 */
public class SmokingKills extends Quest {
	 ...
	 * 			The id to set.
	 */
	public SmokingKills(String name, Player player, QuestStage questStage, QuestType questType) {
