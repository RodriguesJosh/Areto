package com.netty.model.player.quest.deathplateau;
 ...
 * @since Sep 22, 2011 6:33:13 PM
 */
public class DeathPlateau extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DeathPlateau(String name, Player player, QuestStage questStage, QuestType questType) {
