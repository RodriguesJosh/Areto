package com.netty.model.player.quest.elementalworkshopone;
 ...
 * @since Sep 22, 2011 6:27:33 PM
 */
public class ElementalWorkshopOne extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ElementalWorkshopOne(String name, Player player, QuestStage questStage, QuestType questType) {
