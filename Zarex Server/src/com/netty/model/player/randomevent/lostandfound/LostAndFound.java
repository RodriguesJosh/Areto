package com.netty.model.player.randomevent.lostandfound;
 ...
 * @since Sep 22, 2011 6:41:25 PM
 */
public class LostAndFound extends RandomEvent {
	 ...
	 * 			The id to set.
	 */
	public LostAndFound(Player player) {
		super(player);
	}
