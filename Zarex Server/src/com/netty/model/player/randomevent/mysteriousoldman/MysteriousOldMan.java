package com.netty.model.player.randomevent.mysteriousoldman;
 ...
 * @since Sep 22, 2011 6:40:15 PM
 */
public class MysteriousOldMan extends RandomEvent {
	 ...
	 * 			The id to set.
	 */
	public MysteriousOldMan(Player player) {
		super(player);
	}
