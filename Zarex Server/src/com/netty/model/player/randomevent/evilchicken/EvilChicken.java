package com.netty.model.player.randomevent.evilchicken;
 ...
 * @since Sep 22, 2011 6:43:23 PM
 */
public class EvilChicken extends RandomEvent {
	 ...
	 * 			The id to set.
	 */
	public EvilChicken(Player player) {
		super(player);
	}
