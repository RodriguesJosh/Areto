package com.netty.model.player.randomevent.treespirit;
 ...
 * @since Sep 22, 2011 6:35:59 PM
 */
public class TreeSpirit extends RandomEvent {
	 ...
	 * 			The id to set.
	 */
	public TreeSpirit(Player player) {
		super(player);
	}
