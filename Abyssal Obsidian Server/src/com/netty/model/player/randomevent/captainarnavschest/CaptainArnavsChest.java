package com.netty.model.player.randomevent.captainarnavschest;
 ...
 * @since Sep 22, 2011 6:45:08 PM
 */
public class CaptainArnavsChest extends RandomEvent {
	 ...
	 * 			The id to set.
	 */
	public CaptainArnavsChest(Player player) {
		super(player);
	}
