package com.netty.model.player.randomevent.explodingrock;
 ...
 * @since Sep 22, 2011 6:42:51 PM
 */
public class ExplodingRock extends RandomEvent {
	 ...
	 * 			The id to set.
	 */
	public ExplodingRock(Player player) {
		super(player);
	}
