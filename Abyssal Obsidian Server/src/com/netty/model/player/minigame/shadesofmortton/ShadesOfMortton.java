package com.netty.model.player.minigame.shadesofmortton;
 ...
 * @since Sep 22, 2011 1:29:47 PM
 */
public class ShadesOfMortton extends MiniGame {
	 ...
	 * 			The id to set.
	 */
	public ShadesOfMortton(Player player) {
		super(player);
	}
