package com.netty.model.player.quest.digsite;
...
public class Digsite extends Quest {
	 ...
	 * 			The id to set.
	 */
	public Digsite(String name, Player player, QuestStage questStage, QuestType questType) {
