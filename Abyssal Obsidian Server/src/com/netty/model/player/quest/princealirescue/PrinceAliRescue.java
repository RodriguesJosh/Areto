package com.netty.model.player.quest.princealirescue;
...
public class PrinceAliRescue extends Quest {
	 ...
	 * 			The id to set.
	 */
	public PrinceAliRescue(String name, Player player, QuestStage questStage, QuestType questType) {
