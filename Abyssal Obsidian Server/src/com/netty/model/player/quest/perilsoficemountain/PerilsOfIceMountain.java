package com.netty.model.player.quest.perilsoficemountain;
 ...
 * @since Sep 22, 2011 5:00:00 PM
 */
public class PerilsOfIceMountain extends Quest {
	 ...
	 * 			The id to set.
	 */
	public PerilsOfIceMountain(String name, Player player, QuestStage questStage, QuestType questType) {
