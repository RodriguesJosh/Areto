package com.netty.model.player.quest.murdermystery;
...
public class MurderMystery extends Quest {
	 ...
	 * 			The id to set.
	 */
	public MurderMystery(String name, Player player, QuestStage questStage, QuestType questType) {
