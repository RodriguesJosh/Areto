package com.netty.model.player.quest.trollstronghold;
...
public class TrollStronghold extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TrollStronghold(String name, Player player, QuestStage questStage, QuestType questType) {
