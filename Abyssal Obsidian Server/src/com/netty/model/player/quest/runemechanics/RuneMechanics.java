package com.netty.model.player.quest.runemechanics;
 ...
 * @since Sep 22, 2011 4:44:05 PM
 */
public class RuneMechanics extends Quest {
	 ...
	 * 			The id to set.
	 */
	public RuneMechanics(String name, Player player, QuestStage questStage, QuestType questType) {
