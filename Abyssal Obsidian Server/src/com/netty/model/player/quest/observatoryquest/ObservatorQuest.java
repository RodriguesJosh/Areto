package com.netty.model.player.quest.observatoryquest;
 ...
 * @since Sep 22, 2011 5:00:40 PM
 */
public class ObservatorQuest extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ObservatorQuest(String name, Player player, QuestStage questStage, QuestType questType) {
