package com.netty.model.player.quest.mountaindaughter;
 ...
 * @since Sep 22, 2011 5:05:38 PM
 */
public class MountainDaughter extends Quest {
	 ...
	 * 			The id to set.
	 */
	public MountainDaughter(String name, Player player, QuestStage questStage, QuestType questType) {
