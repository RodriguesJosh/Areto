package com.netty.model.player.quest.grimtales;
 ...
 * @since Sep 22, 2011 6:24:57 PM
 */
public class GrimTales extends Quest {
	 ...
	 * 			The id to set.
	 */
	public GrimTales(String name, Player player, QuestStage questStage, QuestType questType) {
