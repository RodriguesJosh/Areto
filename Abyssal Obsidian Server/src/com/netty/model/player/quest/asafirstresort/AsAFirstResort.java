package com.netty.model.player.quest.asafirstresort;
 ...
 * @since Sep 22, 2011 3:56:33 PM
 */
public class AsAFirstResort extends Quest {
	 ...
	 * 			The id to set.
	 */
	public AsAFirstResort(String name, Player player, QuestStage questStage, QuestType questType) {
