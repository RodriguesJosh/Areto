package com.netty.model.player.quest.olafsquest;
 ...
 * @since Sep 22, 2011 5:00:27 PM
 */
public class OlafsQuest extends Quest {
	 ...
	 * 			The id to set.
	 */
	public OlafsQuest(String name, Player player, QuestStage questStage, QuestType questType) {
