package com.netty.model.player.quest.thelosttribe;
 ...
 * @since Sep 22, 2011 4:15:48 PM
 */
public class TheLostTribe extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheLostTribe(String name, Player player, QuestStage questStage, QuestType questType) {
