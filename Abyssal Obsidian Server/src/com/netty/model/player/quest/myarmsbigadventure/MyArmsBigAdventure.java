package com.netty.model.player.quest.myarmsbigadventure;
 ...
 * @since Sep 22, 2011 5:02:30 PM
 */
public class MyArmsBigAdventure extends Quest {
	 ...
	 * 			The id to set.
	 */
	public MyArmsBigAdventure(String name, Player player, QuestStage questStage, QuestType questType) {
