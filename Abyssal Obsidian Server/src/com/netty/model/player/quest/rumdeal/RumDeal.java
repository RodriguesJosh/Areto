package com.netty.model.player.quest.rumdeal;
 ...
 * @since Sep 22, 2011 4:44:16 PM
 */
public class RumDeal extends Quest {
	 ...
	 * 			The id to set.
	 */
	public RumDeal(String name, Player player, QuestStage questStage, QuestType questType) {
