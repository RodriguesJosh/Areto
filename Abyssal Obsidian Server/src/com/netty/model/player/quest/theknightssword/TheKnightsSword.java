package com.netty.model.player.quest.theknightssword;
...
public class TheKnightsSword extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheKnightsSword(String name, Player player, QuestStage questStage, QuestType questType) {
