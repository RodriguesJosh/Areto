package com.netty.model.player.quest.sheepherder;
...
public class SheepHerder extends Quest {
	 ...
	 * 			The id to set.
	 */
	public SheepHerder(String name, Player player, QuestStage questStage, QuestType questType) {
