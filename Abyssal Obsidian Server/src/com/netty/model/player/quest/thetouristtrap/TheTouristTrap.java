package com.netty.model.player.quest.thetouristtrap;
 ...
 * @since Sep 22, 2011 4:04:18 PM
 */
public class TheTouristTrap extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheTouristTrap(String name, Player player, QuestStage questStage, QuestType questType) {
