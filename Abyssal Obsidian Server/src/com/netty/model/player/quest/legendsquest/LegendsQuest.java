package com.netty.model.player.quest.legendsquest;
...
public class LegendsQuest extends Quest {
	 ...
	 * 			The id to set.
	 */
	public LegendsQuest(String name, Player player, QuestStage questStage, QuestType questType) {
