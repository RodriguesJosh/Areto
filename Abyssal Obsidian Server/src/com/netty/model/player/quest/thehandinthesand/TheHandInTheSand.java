package com.netty.model.player.quest.thehandinthesand;
 ...
 * @since Sep 22, 2011 4:23:12 PM
 */
public class TheHandInTheSand extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheHandInTheSand(String name, Player player, QuestStage questStage, QuestType questType) {
