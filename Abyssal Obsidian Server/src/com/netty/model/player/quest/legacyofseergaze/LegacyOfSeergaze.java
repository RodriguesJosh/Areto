package com.netty.model.player.quest.legacyofseergaze;
 ...
 * @since Sep 22, 2011 5:16:38 PM
 */
public class LegacyOfSeergaze extends Quest {
	 ...
	 * 			The id to set.
	 */
	public LegacyOfSeergaze(String name, Player player, QuestStage questStage, QuestType questType) {
