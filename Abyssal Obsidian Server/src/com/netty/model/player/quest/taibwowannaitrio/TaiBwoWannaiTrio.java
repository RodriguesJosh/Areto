package com.netty.model.player.quest.taibwowannaitrio;
 ...
 * @since Sep 22, 2011 4:30:25 PM
 */
public class TaiBwoWannaiTrio extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TaiBwoWannaiTrio(String name, Player player, QuestStage questStage, QuestType questType) {
