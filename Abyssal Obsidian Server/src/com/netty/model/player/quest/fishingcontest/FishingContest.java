package com.netty.model.player.quest.fishingcontest;
...
public class FishingContest extends Quest {
	 ...
	 * 			The id to set.
	 */
	public FishingContest(String name, Player player, QuestStage questStage, QuestType questType) {
