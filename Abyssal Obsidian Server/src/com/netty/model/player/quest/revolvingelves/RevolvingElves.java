package com.netty.model.player.quest.revolvingelves;
 ...
 * @since Sep 22, 2011 4:50:16 PM
 */
public class RevolvingElves extends Quest {
	 ...
	 * 			The id to set.
	 */
	public RevolvingElves(String name, Player player, QuestStage questStage, QuestType questType) {
