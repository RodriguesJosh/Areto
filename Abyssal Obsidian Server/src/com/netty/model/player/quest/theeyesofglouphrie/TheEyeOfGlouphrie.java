package com.netty.model.player.quest.theeyesofglouphrie;
 ...
 * @since Sep 22, 2011 4:28:05 PM
 */
public class TheEyeOfGlouphrie extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheEyeOfGlouphrie(String name, Player player, QuestStage questStage, QuestType questType) {
