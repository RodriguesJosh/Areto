package com.netty.model.player.quest.zogreflesheaters;
 ...
 * @since Sep 22, 2011 1:42:30 PM
 */
public class ZogreFleshEaters extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ZogreFleshEaters(String name, Player player, QuestStage questStage, QuestType questType) {
