package com.netty.model.player.quest.monkeymadness;
...
public class MonkeyMadness extends Quest {
	 ...
	 * 			The id to set.
	 */
	public MonkeyMadness(String name, Player player, QuestStage questStage, QuestType questType) {
