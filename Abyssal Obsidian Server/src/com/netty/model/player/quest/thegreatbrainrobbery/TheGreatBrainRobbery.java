package com.netty.model.player.quest.thegreatbrainrobbery;
 ...
 * @since Sep 22, 2011 4:23:34 PM
 */
public class TheGreatBrainRobbery extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheGreatBrainRobbery(String name, Player player, QuestStage questStage, QuestType questType) {
