package com.netty.model.player.quest.mourningsendone;
 ...
 * @since Sep 22, 2011 5:05:24 PM
 */
public class MourningsEndOne extends Quest {
	 ...
	 * 			The id to set.
	 */
	public MourningsEndOne(String name, Player player, QuestStage questStage, QuestType questType) {
