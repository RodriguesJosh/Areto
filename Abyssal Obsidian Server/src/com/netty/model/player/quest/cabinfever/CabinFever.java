package com.netty.model.player.quest.cabinfever;
 ...
 * @since Sep 22, 2011 6:34:59 PM
 */
public class CabinFever extends Quest {
	 ...
	 * 			The id to set.
	 */
	public CabinFever(String name, Player player, QuestStage questStage, QuestType questType) {
