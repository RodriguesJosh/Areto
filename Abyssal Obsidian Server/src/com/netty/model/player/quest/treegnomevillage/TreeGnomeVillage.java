package com.netty.model.player.quest.treegnomevillage;
...
public class TreeGnomeVillage extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TreeGnomeVillage(String name, Player player, QuestStage questStage, QuestType questType) {
