package com.netty.model.player.quest.enlightenedjourney;
 ...
 * @since Sep 22, 2011 6:27:06 PM
 */
public class EnlightenedJoureny extends Quest {
	 ...
	 * 			The id to set.
	 */
	public EnlightenedJoureny(String name, Player player, QuestStage questStage, QuestType questType) {
