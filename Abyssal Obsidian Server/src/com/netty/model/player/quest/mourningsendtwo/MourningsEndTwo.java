package com.netty.model.player.quest.mourningsendtwo;
 ...
 * @since Sep 22, 2011 5:05:11 PM
 */
public class MourningsEndTwo extends Quest {
	 ...
	 * 			The id to set.
	 */
	public MourningsEndTwo(String name, Player player, QuestStage questStage, QuestType questType) {
