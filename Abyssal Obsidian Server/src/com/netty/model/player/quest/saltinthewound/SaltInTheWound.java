package com.netty.model.player.quest.saltinthewound;
 ...
 * @since Sep 22, 2011 4:43:41 PM
 */
public class SaltInTheWound extends Quest {
	 ...
	 * 			The id to set.
	 */
	public SaltInTheWound(String name, Player player, QuestStage questStage, QuestType questType) {
