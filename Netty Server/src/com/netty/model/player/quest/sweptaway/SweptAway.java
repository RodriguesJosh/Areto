package com.netty.model.player.quest.sweptaway;
...
public class SweptAway extends Quest {

	public SweptAway(String name, Player player, QuestStage questStage, QuestType questType) {
