package com.netty.model.player.quest.thegiantdwarf;
 ...
 * @since Sep 22, 2011 4:24:46 PM
 */
public class TheGiantDwarf extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheGiantDwarf(String name, Player player, QuestStage questStage, QuestType questType) {
