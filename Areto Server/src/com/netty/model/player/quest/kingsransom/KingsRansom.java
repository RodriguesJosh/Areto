package com.netty.model.player.quest.kingsransom;
 ...
 * @since Sep 22, 2011 5:23:48 PM
 */
public class KingsRansom extends Quest {
	 ...
	 * 			The id to set.
	 */
	public KingsRansom(String name, Player player, QuestStage questStage, QuestType questType) {
