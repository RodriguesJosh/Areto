package com.netty.model.player.quest.ernestthechicken;
...
public class ErnestTheChicken extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ErnestTheChicken(String name, Player player, QuestStage questStage, QuestType questType) {
