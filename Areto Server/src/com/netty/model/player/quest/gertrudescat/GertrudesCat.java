package com.netty.model.player.quest.gertrudescat;
...
public class GertrudesCat extends Quest {
	 ...
	 * 			The id to set.
	 */
	public GertrudesCat(String name, Player player, QuestStage questStage, QuestType questType) {
