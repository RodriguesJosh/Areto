package com.netty.model.player.quest.thetaleofthemuspah;
 ...
 * @since Sep 22, 2011 4:04:42 PM
 */
public class TheTaleOfTheMuspah extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheTaleOfTheMuspah(String name, Player player, QuestStage questStage, QuestType questType) {
