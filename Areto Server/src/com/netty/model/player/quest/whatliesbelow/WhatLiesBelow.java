package com.netty.model.player.quest.whatliesbelow;
...
public class WhatLiesBelow extends Quest {
	 ...
	 * 			The id to set.
	 */
	public WhatLiesBelow(String name, Player player, QuestStage questStage, QuestType questType) {
