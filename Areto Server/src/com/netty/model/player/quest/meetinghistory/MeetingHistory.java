package com.netty.model.player.quest.meetinghistory;
 ...
 * @since Sep 22, 2011 4:58:32 PM
 */
public class MeetingHistory extends Quest {
	 ...
	 * 			The id to set.
	 */
	public MeetingHistory(String name, Player player, QuestStage questStage, QuestType questType) {
