package com.netty.model.player.quest.coldwar;
 ...
 * @since Sep 22, 2011 6:34:26 PM
 */
public class ColdWar extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ColdWar(String name, Player player, QuestStage questStage, QuestType questType) {
