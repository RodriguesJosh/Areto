package com.netty.model.player.quest.hauntedmine;
 ...
 * @since Sep 22, 2011 5:46:05 PM
 */
public class HauntedMine extends Quest {
	 ...
	 * 			The id to set.
	 */
	public HauntedMine(String name, Player player, QuestStage questStage, QuestType questType) {
