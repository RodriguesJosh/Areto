package com.netty.model.player.quest.eaglespeak;
 ...
 * @since Sep 22, 2011 6:27:46 PM
 */
public class EaglesPeak extends Quest {
	 ...
	 * 			The id to set.
	 */
	public EaglesPeak(String name, Player player, QuestStage questStage, QuestType questType) {
