package com.netty.model.player.quest.thechosencommander;
 ...
 * @since Sep 22, 2011 4:28:28 PM
 */
public class TheChosenCommander extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheChosenCommander(String name, Player player, QuestStage questStage, QuestType questType) {
