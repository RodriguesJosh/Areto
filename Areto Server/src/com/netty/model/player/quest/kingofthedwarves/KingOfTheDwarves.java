package com.netty.model.player.quest.kingofthedwarves;
 ...
 * @since Sep 22, 2011 5:27:23 PM
 */
public class KingOfTheDwarves extends Quest {
	 ...
	 * 			The id to set.
	 */
	public KingOfTheDwarves(String name, Player player, QuestStage questStage, QuestType questType) {
