package com.netty.model.player.quest.vampyreslayer;
...
public class VampyreSlayer extends Quest {
	 ...
	 * 			The id to set.
	 */
	public VampyreSlayer(String name, Player player, QuestStage questStage, QuestType questType) {
