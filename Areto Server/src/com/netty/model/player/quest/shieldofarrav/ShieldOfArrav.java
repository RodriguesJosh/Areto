package com.netty.model.player.quest.shieldofarrav;
...
public class ShieldOfArrav extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ShieldOfArrav(String name, Player player, QuestStage questStage, QuestType questType) {
