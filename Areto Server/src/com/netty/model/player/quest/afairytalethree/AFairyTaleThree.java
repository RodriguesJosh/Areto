package com.netty.model.player.quest.afairytalethree;
 ...
 * @since Sep 22, 2011 3:55:58 PM
 */
public class AFairyTaleThree extends Quest {
	 ...
	 * 			The id to set.
	 */
	public AFairyTaleThree(String name, Player player, QuestStage questStage, QuestType questType) {
