package com.netty.model.player.quest.thefremenniktrials;
...
public class TheFremennikTrials extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheFremennikTrials(String name, Player player, QuestStage questStage, QuestType questType) {
