package com.netty.model.player.quest.landofthegoblins;
 ...
 * @since Sep 22, 2011 5:23:38 PM
 */
public class LandOfTheGoblins extends Quest {
	 ...
	 * 			The id to set.
	 */
	public LandOfTheGoblins(String name, Player player, QuestStage questStage, QuestType questType) {
