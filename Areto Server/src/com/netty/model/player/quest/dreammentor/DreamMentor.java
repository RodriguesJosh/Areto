package com.netty.model.player.quest.dreammentor;
 ...
 * @since Sep 22, 2011 6:28:15 PM
 */
public class DreamMentor extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DreamMentor(String name, Player player, QuestStage questStage, QuestType questType) {
