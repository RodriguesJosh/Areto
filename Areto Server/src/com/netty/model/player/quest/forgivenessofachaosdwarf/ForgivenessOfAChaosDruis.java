package com.netty.model.player.quest.forgivenessofachaosdwarf;
 ...
 * @since Sep 22, 2011 6:26:11 PM
 */
public class ForgivenessOfAChaosDruis extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ForgivenessOfAChaosDruis(String name, Player player, QuestStage questStage, QuestType questType) {
