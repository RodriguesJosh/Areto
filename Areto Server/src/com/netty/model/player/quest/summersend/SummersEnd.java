package com.netty.model.player.quest.summersend;
 ...
 * @since Sep 22, 2011 4:31:05 PM
 */
public class SummersEnd extends Quest {
	 ...
	 * 			The id to set.
	 */
	public SummersEnd(String name, Player player, QuestStage questStage, QuestType questType) {
