package com.netty.model.player.quest.darknessofhallowvale;
 ...
 * @since Sep 22, 2011 6:33:44 PM
 */
public class DarknessOfHallowvale extends Quest {
	 ...
	 * 			The id to set.
	 */
	public DarknessOfHallowvale(String name, Player player, QuestStage questStage, QuestType questType) {
