package com.netty.model.player.quest.elementalworkshoptwo;
 ...
 * @since Sep 22, 2011 6:27:20 PM
 */
public class ElementalWorkshopTwo extends Quest {
	 ...
	 * 			The id to set.
	 */
	public ElementalWorkshopTwo(String name, Player player, QuestStage questStage, QuestType questType) {
