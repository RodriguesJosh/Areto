package com.netty.model.player.quest.onesmallfavor;
 ...
 * @since Sep 22, 2011 5:00:13 PM
 */
public class OneSmallFavor extends Quest {
	 ...
	 * 			The id to set.
	 */
	public OneSmallFavor(String name, Player player, QuestStage questStage, QuestType questType) {
