package com.netty.model.player.quest.thebranchesofdarkmeyer;
 ...
 * @since Sep 22, 2011 4:28:43 PM
 */
public class TheBranchesOfDarkmeyer extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheBranchesOfDarkmeyer(String name, Player player, QuestStage questStage, QuestType questType) {
