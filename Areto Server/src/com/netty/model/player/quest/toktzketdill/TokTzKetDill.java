package com.netty.model.player.quest.toktzketdill;
 ...
 * @since Sep 22, 2011 4:00:22 PM
 */
public class TokTzKetDill extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TokTzKetDill(String name, Player player, QuestStage questStage, QuestType questType) {
