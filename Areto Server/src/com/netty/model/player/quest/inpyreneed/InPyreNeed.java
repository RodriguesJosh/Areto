package com.netty.model.player.quest.inpyreneed;
 ...
 * @since Sep 22, 2011 5:42:49 PM
 */
public class InPyreNeed extends Quest {
	 ...
	 * 			The id to set.
	 */
	public InPyreNeed(String name, Player player, QuestStage questStage, QuestType questType) {
