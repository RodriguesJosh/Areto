package com.netty.model.player.quest.wanted;
 ...
 * @since Sep 22, 2011 1:44:11 PM
 */
public class Wanted extends Quest {
	 ...
	 * 			The id to set.
	 */
	public Wanted(String name, Player player, QuestStage questStage, QuestType questType) {
