package com.netty.model.player.quest.withinthelight;
 ...
 * @since Sep 22, 2011 1:42:56 PM
 */
public class WithinTheLight extends Quest {
	 ...
	 * 			The id to set.
	 */
	public WithinTheLight(String name, Player player, QuestStage questStage, QuestType questType) {
