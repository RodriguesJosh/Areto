package com.netty.model.player.quest.thefremennikisles;
 ...
 * @since Sep 22, 2011 4:27:53 PM
 */
public class TheFremennikIsles extends Quest {
	 ...
	 * 			The id to set.
	 */
	public TheFremennikIsles(String name, Player player, QuestStage questStage, QuestType questType) {
