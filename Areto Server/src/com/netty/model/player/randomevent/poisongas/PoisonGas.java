package com.netty.model.player.randomevent.poisongas;
 ...
 * @since Sep 22, 2011 6:39:20 PM
 */
public class PoisonGas extends RandomEvent {
	 ...
	 * 			The id to set.
	 */
	public PoisonGas(Player player) {
		super(player);
	}
