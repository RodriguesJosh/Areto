...
public class PacketSender {
	...
	public PacketSender getLogin() {
		// this.getMessage("Welcome!");// .interfaces().skills();
	...
	public PacketSender getMessage(String message) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.MESSAGE, PacketType.VARIABLE_BYTE).putString(World.getWorld().getGoogleTranslatedLanguage(this.getPlayer(), message)));
		}
		return this;
	}
	...
	public PacketSender getLogout() {
		if (this.getPlayer() != null) {
			...
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.LOGOUT).toPacket()).addListener(new ChannelFutureListener() {
				@Override
	...
	public PacketSender getInventory() {
		PacketBuilder packetBuilder = new PacketBuilder(EncodedPacketConstants.TYPE_CONTAINER, PacketType.VARIABLE_SHORT).putShort((short) 3214);
	...
	public PacketSender getEquipment() {
		PacketBuilder packetBuilder = new PacketBuilder(EncodedPacketConstants.EQUIPMENT, PacketType.VARIABLE_SHORT).putShort(1688);
	...
	public PacketSender getBank() {
		PacketBuilder packetBuilder = new PacketBuilder(EncodedPacketConstants.TYPE_CONTAINER, PacketType.VARIABLE_SHORT).putShort(5382);
		int itemLength = this.getPlayer().getEquipment().getEquipmentContainer().getItems().length;
		packetBuilder.putShort(itemLength);
		for (int i = 0; i < itemLength; i++) {
	...
	public PacketSender getInventoryBank() {
		PacketBuilder packetBuilder = new PacketBuilder(EncodedPacketConstants.TYPE_CONTAINER, PacketType.VARIABLE_SHORT).putShort(5064);
		int itemLength = this.getPlayer().getEquipment().getEquipmentContainer().getItems().length;
	...
	public PacketSender getOpenBank() {
		if (this.getPlayer() != null) {
			PacketBuilder packetBuilder = new PacketBuilder(EncodedPacketConstants.BANK).putShortA(5292).putShort(5063);
	...
	public PacketSender getText(String text, int id) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.TEXT, PacketType.VARIABLE_SHORT).putString(text).putShortA(id).toPacket());
		}
		return this;
	}
	...
	public PacketSender getShownInterface(int interfaceID) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.INTERFACE).putShort(interfaceID).toPacket());
		}
		return this;
	}
	...
	/** public PacketSender getPrivateMessageStatus(byte status) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(PacketConstants.PRIVATE_MESSAGE_STATUS).putByte(status).toPacket());
		}
		return this;
	} */
	...
	public PacketSender getRemovedWindows() {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.REMOVE_WINDOWS).toPacket());
		}
		return this;
	}
	...
	public PacketSender energy() {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.ENERGY).putByte((byte) this.getPlayer().getEnergy().getEnergyAmount()).toPacket());
		}
		return this;
	}
	...
	public PacketSender getNPCTalk(String s, String s1, String s2, int chatNPC, String name) {
		if (this.getPlayer() != null) {
			this.getFrame200(4894, 591).getText(name, 4895).getText(s, 4896).getText(s1, 4897).getText(s2, 4897).getFrame75(chatNPC, 4893).getFrame164(4893);
		}
		return this;
	}
	...
	public PacketSender getFrame200(int mainFrame, int subFrame) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.PACKET_200).putShort(mainFrame).putShort(subFrame).toPacket());
		}
		return this;
	}
	...
	public PacketSender getFrame164(int frame) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.PACKET_164).putLEShort(frame).toPacket());
		}
		return this;
	}
	...
	public PacketSender getFrame248(int mainFrame, int subFrame) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.PACKET_248).putShortA(mainFrame).putShort((short) subFrame).toPacket());
		}
		return this;
	}
	...
	public PacketSender getFrame185(int frame) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.PACKET_185).putLEShortA(frame).toPacket());
		}
		return this;
	}
	...
	public PacketSender getFrame75(int mainFrame, int subFrame) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.PACKET_75).putLEShortA(mainFrame).putLEShortA(subFrame).toPacket());
		}
		return this;
	}
	...
	public PacketSender getMenuOption(int i, int l, String text) {// , int a) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.MENU_OPTION, PacketType.VARIABLE_BYTE).putByteC((byte) i).putByteA((byte) l).putString(text).toPacket());
		}
		return this;
	}
	...
	public PacketSender getInterfaceInventory(int interfaceID, int inventoryInterfaceID) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.INVENTORY).putShortA(interfaceID).putShort(inventoryInterfaceID).toPacket());
		}
		return this;
	}
	...
	public PacketSender getRegisteredGroundItem(Item item) {
		if (this.getPlayer() != null) {
			...
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.ENTITY_LOCATION).putByteC(y).putByteC(x).toPacket());
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.ITEM_DEFINITION).putLEShortA(item.getID()).putShort(item.getAmount()).putByte((byte) 0).toPacket());
		}
		return this;
	}
	...
	public PacketSender getUnregisteredGroundItem(Item item) {
		if (this.getPlayer() != null) {
			...
			int y = item.getLocation().getY() - (this.getPlayer().getLastLocation().getRegionY() * 8);
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.ENTITY_LOCATION).putByteC(y).putByteC(x).toPacket());
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.ITEM_ID).putByteS(0).putShort(item.getID()).toPacket());
		}
		return this;
	}
	...
	public PacketSender getBankPin(String message) {
		if (this.getPlayer() != null) {
			this.getPlayer().getChannel().write(new PacketBuilder(EncodedPacketConstants.BANK_PIN).putLEShortA(1).toPacket());
